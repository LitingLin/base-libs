...
_ENSURE_NE_WITH_HANDLER_5(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode, handler)
...
_ENSURE_NE_4(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode)
...
_ENSURE_GE_WITH_HANDLER_5(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode, handler)
...
_ENSURE_GE_4(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode)
...
_ENSURE_GT_WITH_HANDLER_5(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode, handler)
...
_ENSURE_GT_4(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode)
...
_ENSURE_LE_WITH_HANDLER_5(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode, handler)
...
_ENSURE_LE_4(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode)
...
_ENSURE_LT_WITH_HANDLER_5(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode, handler)
...
_ENSURE_LT_4(leftExp, rightExp, Base::ErrorCodeType::USERDEFINED, errorCode)
